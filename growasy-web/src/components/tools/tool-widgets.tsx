...
/**
 * Interactive tool widgets shared by the in-app Tools page and the public,
 * SEO-facing tool pages. Pure client-side (no API, no auth) — safe to render for
 * logged-out visitors.
 */

/** Copy text to clipboard with a transient "copied" flag + toast fallback. */
function useCopy() {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Enter a topic or a few keywords. We mix broad, niche, and long-tail tags so your posts get
          discovered and stay rankable.
        </CardDescription>
      </CardHeader>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Engagement rate = (avg likes + avg comments) ÷ followers × 100. Enter your averages to see
          how you stack up.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
